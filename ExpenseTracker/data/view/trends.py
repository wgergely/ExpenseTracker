...
class TrendGraph(QtWidgets.QWidget):
    ...
    def _init_actions(self) -> None:
        ...
        action = QtGui.QAction('Show Bars', self, checkable=True)
        action.setChecked(self._show_bars)
        action.toggled.connect(self.toggle_bars)
        ...
        action = QtGui.QAction('Show Trend', self, checkable=True)
        action.setChecked(self._show_trend)
        action.toggled.connect(self.toggle_trend)
        ...
        action = QtGui.QAction('Show Axes', self, checkable=True)
        action.setChecked(self._show_axes)
        action.toggled.connect(self.toggle_axes)
        ...
        action = QtGui.QAction('Show Ticks', self, checkable=True)
        action.setChecked(self._show_ticks)
        action.toggled.connect(self.toggle_ticks)
        ...
        action = QtGui.QAction('Show Labels', self, checkable=True)
        action.setChecked(self._show_labels)
        action.toggled.connect(self.toggle_labels)
        ...
        action = QtGui.QAction('Show Tooltip', self, checkable=True)
        action.setChecked(self._show_tooltip)
        action.toggled.connect(self.toggle_tooltip)
