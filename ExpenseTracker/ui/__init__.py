...
def get_year_month():
    ...
    from . import main
    start, end = main.main_widget.action_bar.range_selector.get_range()
    return start, end

def get_span():
    """Get the current date span from the main widget."""
    from . import main
    return main.main_widget.action_bar.range_selector.get_range_span()
...
def index():
    ...
    model = main.main_widget.expense_view.selectionModel()
